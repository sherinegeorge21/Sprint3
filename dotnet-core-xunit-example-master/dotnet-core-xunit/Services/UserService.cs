...
namespace dotnet_core_xunit.Services
{
    public interface IUserService
    {
        ...
        UserDto.User UpdateUser(UserDto.User user);
    ...
    public class UserService : IUserService
    {
        ...
        public UserDto.User UpdateUser(UserDto.User user)
        {
            Users user_ = _mapper.Map<Users>(user);
            Users users = _testDbContext.Users.Where(w => w.Id == user.Id).FirstOrDefault();
            ...
            if (users != null)
            {
                _testDbContext.Users.Remove(users);
                _testDbContext.SaveChanges();
                _testDbContext.Users.Add(user_);
